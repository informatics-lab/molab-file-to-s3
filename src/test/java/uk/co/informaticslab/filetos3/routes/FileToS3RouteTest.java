...
public class FileToS3RouteTest extends CamelSpringTestSupport {
    ...
    public void setUp() throws Exception {
        ...
        route = new FileToS3Route(testDirectory.getRoot().getAbsolutePath(), TO_BUCKET);
    ...
    public void testFileComponentConsumerPath() throws Exception {
        ...
        String expected = "file://" + testDirectory.getRoot().getAbsolutePath() + "?initialDelay=1000&delete=true";
    ...
    private File writeFileToTestPath(byte[] content) throws Exception {
        File f = testDirectory.newFile(FILENAME);
